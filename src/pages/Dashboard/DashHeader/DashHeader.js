...
const DashHeader = ({ url }) => {
    ...
    return (
        <div>
            <h2 style={{borderBottom: '1px solid rgba(255, 255, 255, 0.2)'}} className="text-center pt-3 pb-3 my-0 bg-dark text-light"><Link style={{color: 'unset', textDecoration: 'unset'}} to={`${url}`}>Dashboard</Link></h2>
